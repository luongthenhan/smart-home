...
public class HomeResource {
	...
	public ResponseEntity<Void> updateEnabled(@PathVariable int homeId,
			@RequestBody Map<String, Boolean> updateMap) {
		...
		boolean updateSuccess = homeService.updateEnabled(homeId,
				updateMap.get("enabled"));
	...
	public ResponseEntity<Void> updateDevice(@PathVariable int deviceTypeId,
	...
	public ResponseEntity<Void> updateDevice(@PathVariable int homeId,
		...
		deviceService.updateDevice(homeId, deviceId, deviceTypeId,
				updatedDevice);
		return new ResponseEntity<Void>(HttpStatus.NO_CONTENT);
	}
	 ...
	 * @throws NotSupportedException
	 */
	@RequestMapping(method = RequestMethod.GET, path = "{homeId}/devices")
	public ResponseEntity<List<Device>> getAllDevices(@PathVariable int homeId)
		...
		return new ResponseEntity<List<Device>>(deviceService.getAllDevices(homeId),
				HttpStatus.OK);
	}

	@RequestMapping(method = RequestMethod.GET, path = "{homeId}/availableGPIOs")
	public ResponseEntity<List<Integer>> getAllAvailableGPIOs(
			@PathVariable int homeId) {
		return new ResponseEntity<List<Integer>>(
				deviceService.getAllAvailableGpio(homeId), HttpStatus.OK);
	}
