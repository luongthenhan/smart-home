...
import com.hcmut.smarthome.sec.impl.CustomUserDetails;
...
public class HomeResource {
	...
	public ResponseEntity<String> addHome(@RequestBody Home home) {
		...
		int addedHomeId = homeService.addHome(authService.getCurrentUserId(), home);
		if (addedHomeId > 0) {
	...
	public ResponseEntity<List<Home>> getHomes() {
		return new ResponseEntity<List<Home>>(
				homeService.getAllHomes(authService.getCurrentUserId()), HttpStatus.OK);
	}
